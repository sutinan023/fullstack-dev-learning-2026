...
import { createArtist }  from '@/app/artists/action';
...
const className = {
  ...
  input:
    "w-full rounded-lg border border-gray-300 px-3 py-2 text-black focus:outline-none focus:ring-2 focus:ring-indigo-600",
  error: "text-sm text-red-600 mt-3",
  submit:
    "bg-indigo-600 hover:bg-indigo-700 disabled:opacity-50 disabled:cursor-not-allowed text-white font-semibold px-6 py-2 rounded-lg shadow",
};
  ...
  return (
    <div className={className.card}>
      ...
      <form action={formAction}>
        ...
        <div className={className.field}>
          <label htmlFor="image" className={className.label}>
            Image URL
          </label>
          <input
            type="text"
